...
This folder contains sample input files used to test validation rules
and the end-to-end data submission workflow.
...
- Ensure files follow the official template unless intentionally
  breaking it

## Data sensitivity

These test files must contain **synthetic** data only. No real
submissions or real-world data to be used.
